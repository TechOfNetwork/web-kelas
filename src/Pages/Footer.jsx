					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/chenkwand_?igsh=MWw3b3V3eGloem55bQ==" class="hover:underline">
									    Chenkwand
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/_techofnetwork?igsh=MW5lMW93NnViN2d5aw==" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
									<a href="https://open.spotify.com/playlist/3ZR7cyN2GXTvCDukAkxoCP" class="hover:underline">
									    Spotify
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas XI TJKT 3 | Di Kelola Oleh Siswa TJKT 3
						</p>
					</div>
				</div>
			</div>
