...
const Schedule = () => {
    ...
    piketGroup = [
        ["Afif", "Althaf", "Aditya", "Chenk Wand", "Defa", "Nabila",, "Ryan", "Zafran"],
        ["Faradilla", "Moreno", "Najwa", "Aldo", "Adit restu", "Ferdi", "Miftha alfarizi"],
        ["Fatimah", "Meyasa", "Rahma", "Aulia", "Aldi", "Aziz", "Dafa"],
        ["Amanda", "Eka", "Vino", "Rakha", "Romo", "Davit", "Qul rahzam"],
        ["Abi rafdi", "Dzakwan", "Miftha aulia", "Nur aulia", "Virgi", "Fazil", "Syahrizan"],
    ]
