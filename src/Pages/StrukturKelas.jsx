	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="Yossi Herlina S.Pd" Width="150px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[-3rem]" data-aos="fade-up" data-aos-duration="1200">
					<div className="relative left-[0.2rem]">
						<BorderStruktur Jabatan="Ketua Kelas" Nama="M.Althaf Prayata" Width="120px" />
					</div>
					...
					<div className="relative right-[0.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Muhammad Afif" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Sekertaris" Nama="Nabila Rizki" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama=" Fatimah Azzahra" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Amanda Cantika" Width="120px" />
						<div className="py-[3%]"></div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Kebersihan" Nama="Chenkwand" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Moreno" Width="120px" />
					</div>	

					<div className="flex-col">
						<BorderStruktur Jabatan="Seksi Sosial" Nama="M.Zafran" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Eka WIdiani" Width="120px" />
					</div>

					<div className="flex-col hidden lg:flex">
						<BorderStruktur Jabatan="Keagamaan" Nama="Abi Rafdi" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Ferdi" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					data-aos-duration="1100">
					<div className="flex-col">
						<BorderStruktur Jabatan="Seksi Apresiasi Seni" Nama=" Miftha Aulia" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Vino" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Seksi Daya Kreasi" Nama="Miftha" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Virgi" Width="120px" />
					</div>
				</div>
				...
				<div className=" absolute bottom-[15%] " data-aos="fade-up" data-aos-duration="1000">
					<div className="flex justify-center items-center flex-col">
						...
						<img src="LineVertikal3.svg" alt="" className="lg:h-[60px] lg:-z-50" />
						<img src="LineVertikal3.svg" alt="" className="lg:hidden" />
						<img src="Circle.svg" alt="" className="relative top-[-0.7rem]" />
						<div className="relative bottom-3">
							<BorderStruktur Jabatan="Keamanan" Nama="Dafa" Width="120px" />
						</div>
					</div>
				</div>
